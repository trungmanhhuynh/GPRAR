...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input_dir', default='/home/manhh/github/datasets/processed_data/features/titan/flow')
    parser.add_argument(
        '--output_dir', default='/home/manhh/github/datasets/processed_data/features/titan/gridflow')
    parser.add_argument(
