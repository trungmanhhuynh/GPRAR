...
def generate_data(args, mode):
    ...
    for video_name in video_dir:
        ...
        for frame_name in frame_list:
            ...
            with open(os.path.join(args.gridflow_path, video_name, "{:06d}_gridflow.json".format(frame_number)),
                      "r") as f:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Generate train/val data for prediction on titan')
    parser.add_argument(
    ...
    parser.add_argument(
        '--gridflow_path', default='/home/manhh/github/datasets/processed_data/features/titan/gridflow')
    parser.add_argument(
        '--out_folder', default='/home/manhh/github/datasets/processed_data/prediction/titan/')
    parser.add_argument(
